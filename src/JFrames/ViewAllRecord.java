...
public class ViewAllRecord extends javax.swing.JFrame {
    ...
    public void searchData(){
        ...
        try{
            Connection con = DbConnect.getConnection();
            String qur = "select * from issue_book where issue_dt between ? and ?";
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 40, -1, -1));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1300, 180, 140, 50));
